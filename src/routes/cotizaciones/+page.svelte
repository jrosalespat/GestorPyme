...
<div class="empty-state">
  ...
  <span class="empty-sub">Crea la primera cotización para tus clientes.</span>
</div>
...
<style>
  ...
  .empty-state p { font-size: 1rem; font-weight: 500; color: #f0f0f5; }
